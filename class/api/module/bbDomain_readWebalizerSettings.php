...
/**
 * Implementation of bbDomain::readWebalizerSettings
 *
 * @package system\module
 */
class bbDomain_readWebalizerSettings extends apiModule
{
    protected $rpcMethod = 'bbDomain::readWebalizerSettings';
